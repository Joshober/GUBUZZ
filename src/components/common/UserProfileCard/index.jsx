...
import { getSingleStatus, getSingleUser, deleteConnection, getConnections, addConnection, getConnectionCount, getRequestCount, getPostCount } from "../../../api/FirestoreAPI";
...
export default function ProfileCard({  currentUser, profileuser , edit, onEdit}) {
  ...
  useEffect(() => {
    getConnections(currentUser.id, profileuser, setIsConnected);
  ...
  const isCurrentUserProfile = currentUser.id === profileuser;

  const handleConnect = () => {
    addConnection(currentUser.id, profileuser);
  };
          ...
          {allStatuses?.map((posts) => {
            return (
              <div key={posts.postID}>
                <PostsCard post={posts} user= {currentUser} />
